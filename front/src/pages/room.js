...
/*************************************************
 * exios HTTP 단방향 통신
 * POST /room 은 라우터는 채팅방을 만드는 라우터입니다.
 * GET /room/:roomId 는 채팅방을 렌더링 하는 라우터 입니다.
 * DELET /room/:roomId 는 채팅방을 삭제하는 라우터 입니다.
 *************************************************/

const Room = () => {
  const socket = io.connect('http://localhost:8085/room', {
    /****************************************************************************************
     * [transports의 역할]
